...
#define EN				0x00010000			// P0.16 is EN
#define RS				0x00008000			// P0.15 is RS
#define CTRL_BUS		0x00018000			// P0.[16:15]		EN, RS
#define DATA_BUS		0x07800000			// P0.[26:23]	DB7,DB6,DB5,DB4
#define FULL_BUS		0x07818000			// P0.[26:23,16:15]	DB7,DB6,DB5,DB4,EN,RS
#define DB4_PIN_SHIFT	23					// DB4 is on P0.23
#define DB4_PIN			0x00800000			// DB5 is on P0.23
#define DB5_PIN			0x01000000			// DB5 is on P0.12

#define FULL_BUS_CLEAR	{LPC_GPIO0->FIOCLR = FULL_BUS;}	// Full bus clear
#define FULL_BUS_OUT	{LPC_GPIO0->FIODIR |= FULL_BUS;}	// Full bus as output
